...
import { DefaultTransporter, Transporter } from '.pnpm/google-auth-library@9.15.1/node_modules/google-auth-library/build/src/transporters';
import { CredentialBody, ImpersonatedJWTInput, JWTInput } from '.pnpm/google-auth-library@9.15.1/node_modules/google-auth-library/build/src/auth/credentials';
import { IdTokenClient } from '.pnpm/google-auth-library@9.15.1/node_modules/google-auth-library/build/src/auth/idtokenclient';
import { GCPEnv } from '.pnpm/google-auth-library@9.15.1/node_modules/google-auth-library/build/src/auth/envDetect';
import { JWT, JWTOptions } from '.pnpm/google-auth-library@9.15.1/node_modules/google-auth-library/build/src/auth/jwtclient';
import { Headers, OAuth2ClientOptions } from '.pnpm/google-auth-library@9.15.1/node_modules/google-auth-library/build/src/auth/oauth2client';
import { UserRefreshClient, UserRefreshClientOptions } from '.pnpm/google-auth-library@9.15.1/node_modules/google-auth-library/build/src/auth/refreshclient';
import { Impersonated, ImpersonatedOptions } from '.pnpm/google-auth-library@9.15.1/node_modules/google-auth-library/build/src/auth/impersonated';
import { ExternalAccountClientOptions } from '.pnpm/google-auth-library@9.15.1/node_modules/google-auth-library/build/src/auth/externalclient';
import { BaseExternalAccountClient } from '.pnpm/google-auth-library@9.15.1/node_modules/google-auth-library/build/src/auth/baseexternalclient';
...
import { ExternalAccountAuthorizedUserClient } from '.pnpm/google-auth-library@9.15.1/node_modules/google-auth-library/build/src/auth/externalAccountAuthorizedUserClient';
import { AnyAuthClient } from '.pnpm/google-auth-library@9.15.1/node_modules/google-auth-library';
/**
