...
import { cloudresourcemanager_v1 } from '.pnpm/googleapis@133.0.0/node_modules/googleapis/build/src/apis/cloudresourcemanager/v1';
import { cloudresourcemanager_v1beta1 } from '.pnpm/googleapis@133.0.0/node_modules/googleapis/build/src/apis/cloudresourcemanager/v1beta1';
import { cloudresourcemanager_v2 } from '.pnpm/googleapis@133.0.0/node_modules/googleapis/build/src/apis/cloudresourcemanager/v2';
import { cloudresourcemanager_v2beta1 } from '.pnpm/googleapis@133.0.0/node_modules/googleapis/build/src/apis/cloudresourcemanager/v2beta1';
import { cloudresourcemanager_v3 } from '.pnpm/googleapis@133.0.0/node_modules/googleapis/build/src/apis/cloudresourcemanager/v3';
